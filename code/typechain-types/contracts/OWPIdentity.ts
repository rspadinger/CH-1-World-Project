...
export interface OWPIdentityInterface extends utils.Interface {
  functions: {
    ...
    "burnBatchMultiple(address[],uint256[],uint256[])": FunctionFragment;
...
export interface OWPIdentity extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OWPIdentityInterface;
