...
//ERC1155Supply: adds supply tracking functionality
contract OWPIdentity is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply, NativeMetaTransaction {
  ...
  function burnBatch(address to, uint256[] memory ids, uint256[] memory amounts) public override onlyRole(MINTER_ROLE) {
  ...
  //this prevents tokens from being transferred
  function _update(
    address from,
    address to,
    uint256[] memory ids,
